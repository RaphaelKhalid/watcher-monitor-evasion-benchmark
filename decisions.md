...
- Demo update: added a non-executing left-to-right before/after flow for all six deterministic auto-allows. The after panel is explicitly labeled a proposed shell-aware remediation, not a live Watcher patch.
